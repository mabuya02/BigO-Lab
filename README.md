...
│   │   ├── playground-shell.tsx      # Main workspace shell
│   │   ├── playground/
│   │   │   ├── left-panel.tsx        # Library & experiment config
│   │   │   └── bottom-panel.tsx      # Console, charts, analysis tabs
│   │   ├── monaco-surface.tsx        # Monaco editor wrapper
│   │   └── metric-chart.tsx          # Recharts visualization
│   ├── lib/
│   │   ├── api.ts             # API client (backend / mock modes)
│   │   ├── types.ts           # TypeScript interfaces
│   │   └── mock-playground.ts # Mock data for UI-only development
│   └── store/                 # Zustand state management
│
├── backend/                   # FastAPI analysis & execution API
│   ├── app/
│   │   ├── main.py            # App factory, middleware, CORS
│   │   ├── api/routes/        # Route handlers
│   │   │   ├── playground.py  # Run & experiment endpoints
│   │   │   ├── execution.py   # Direct code execution
│   │   │   ├── experiments.py # Experiment management
│   │   │   ├── explanations.py# LLM explanation generation
│   │   │   ├── comparisons.py # Side-by-side comparison
│   │   │   ├── presets.py     # Algorithm preset library
│   │   │   ├── shares.py      # Session sharing
│   │   │   └── health.py      # Health & status checks
│   │   ├── services/          # Business logic layer
│   │   │   ├── execution_service.py   # Code runner orchestration
│   │   │   ├── experiment_service.py  # Multi-size experiment runner
│   │   │   ├── complexity_service.py  # Complexity curve fitting
│   │   │   ├── explanation_service.py # LLM / heuristic explanations
│   │   │   ├── comparison_service.py  # Experiment diff analysis
│   │   │   ├── metrics_service.py     # Line-level metric collection
│   │   │   └── playground_service.py  # High-level playground ops
│   │   ├── execution/         # Code execution backends
│   │   ├── experiments/       # Input generation & profiling
│   │   ├── instrumentation/   # Runtime instrumentation
│   │   ├── integrations/      # External services (Ollama Cloud)
│   │   ├── presets/           # Built-in algorithm definitions
